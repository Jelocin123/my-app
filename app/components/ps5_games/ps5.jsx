...
import styles from "../../styles/ps5.module.scss";
          ...
          <section className='col-6'>
            <div className='row'>
              <section className='col-xxl-2 col-xl-3 col-4 ms-1'>
                <p className='m-0' id={styles.PS5}><i className="bi bi-playstation"></i> PS5</p>
              </section>
            </div>
          </section>
          <section className='col-6'>
        ...
        <div className="row gx-3 gy-3 " id={styles.me}>
          {ps5Data.map((game, index) => (
            <section className="col-xxl-2 col-xl-3 col-md-6 col-4 mt-0" data-aos="fade-down"
              data-aos-delay="200" data-aos-once="true" id={styles.me2} key={index}>
